...
export const HELP_SECTIONS = Object.freeze([
  ...
  },
  {
    ...
    keywords: "dépannage erreur problème clé invalide modèle image format réseau connexion session pwa cache version mise à jour actualiser",
    blocks: [
      {
      ...
      {
        title: "La PWA semble utiliser une ancienne version",
        body: "Ouvre le menu, choisis À propos puis Vérifier les mises à jour. Si une nouvelle livraison est annoncée, utilise Recharger maintenant.",
      },
    ],
  },
]);
