...
export const HELP_SECTIONS = Object.freeze([
  ...
  },
  {
    ...
    keywords: "ia intelligence artificielle anthropic claude clé api modèle byok vault session résumé quota coût confidentialité",
    blocks: [
      {
      ...
      },
      {
        ...
        bullets: [
          "Le quota Capsule est de dix appels externes par minute et par utilisateur.",
